...
from solution.normal_crucible import Crucible
...
class Part1:
    ...
    def solve(self) -> None:
        ...
        initial_pos = Crucible(self.grid, 0, 0, "d", 0, 0)
        self.grid_pos[0][0] = {0: {initial_pos.hash(): initial_pos}}
