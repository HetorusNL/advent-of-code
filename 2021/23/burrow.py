...
class Burrow:
    ...
    def simulate(self):
        ...
        # check whether the burrow is finished (all amphipods in correct room)
        for new_burrow in new_burrows:
            finished = True
            for y in [1, 2]:
            ...
            # if finished:
            #     print("finished")
            new_burrow._finished = finished
        # if not new_burrows:  # TODO: temp code
        #     # self.print()
        #     self._finished = True
        #     return [self]
        return new_burrows
    ...
    def _handle_room_amphipod(self, y, x):
        ...
        for new_x in range(x, -1, -1):  # from current pos to the left
            ...
            new_burrows.append(self._create_amphipod(y, x, 0, new_x))
