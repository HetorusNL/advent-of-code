...
class Part2:
    ...
    def solve_single(self, left: int, right: list[int], operation: Operation, equation: Equation):
        match operation:
            ...
            case Operation.CONCAT:
                left = int(str(left) + str(right.pop(0)))
        if right:
            ...
            self.solve_single(left, right.copy(), Operation.CONCAT, equation)
        else:
    ...
    def solve_equation(self, equation: Equation):
        ...
        self.solve_single(left, equation.numbers.copy(), Operation.CONCAT, equation)
